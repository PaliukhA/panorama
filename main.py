...
pano_image_collection = io.ImageCollection('jpeg/lowres/' + strtest + '_*.jpg',
...
print(len(pano_image_collection))
# ------------------------------------------------------------------------------------------
# Part 1
# ------------------------------------------------------------------------------------------
...
robust_transform, matches = panorama.ransac_transform(src_keypoints, src_descriptors, dest_keypoints,
...
plots.plot_result(result)
io.imsave('./results/improved_pano' + strtest + '.jpeg', result)
